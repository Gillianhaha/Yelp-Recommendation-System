...
To start the project, make sure you have npm installed on you laptop and then execute the following commend
1. Run `npm install`
2. Run `./start_frontend_server.sh`


# Section below are created by [Create React App](https://github.com/facebook/create-react-app).
## Available Scripts
